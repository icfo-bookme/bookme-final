      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className='col-span-1'>
          <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 sticky top-4">
            ...
            {/* Search Filter */}
            <div className="mb-6">
              <label className="block text-sm font-bold text-blue-950 mb-1">Search By Property Name</label>
              <input
                type="text"
                placeholder="Search vehicles..."
                value={filters.search}
                onChange={(e) => handleSearchChange(e.target.value)}
                className="w-full p-2 border-2  rounded-md ring-blue-500 border-blue-950"
              />
            </div>
            
            {/* Seat Filter */}
            <div className="mb-6">
              <label className="block text-sm font-bold text-blue-950 mb-2">Seating Capacity</label>
            ...
            {/* Brand Filter */}
            <div className="mb-6">
              <label className="block text-sm font-bold text-blue-950 mb-2">Brands</label>
            ...
            {/* Model Filter */}
            <div className="mb-6">
              <label className="block text-sm font-bold text-blue-950 mb-2">Models</label>
              <div className="max-h-40 overflow-y-auto space-y-2">
