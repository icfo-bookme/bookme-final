...
export default function Tangour() {
    ...
    return (
        <div className={`${roboto.className} bg-white w-full mx-auto  py-6 md:py-10 lg:py-12 max-w-7xl`}>
            ...
            {loading ? (
                ...
                <div className="flex justify-center items-center h-[200px]">
                    <p className="text-gray-600 text-base sm:text-lg">No properties available at the moment.</p>
                </div>
            )}
        </div>
    );
